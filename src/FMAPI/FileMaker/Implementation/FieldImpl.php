...
class FileMaker_Field_Implementation
{
    ...
    public function validate($V2063c160, $Vcb5e100e = null)
    {
        $V1c0c74f6 = true;
        if ($Vcb5e100e === null) {
            $V1c0c74f6 = false;
    ...
    public function checkTimeValidity($V2063c160, $V981c1e7b, $Vcb5e100e, $Vcaf85b7b)
    {
        $V52124c01 = 0;
        if ($Vcaf85b7b) {
            $V52124c01 = 12;
    ...
    public function hasValidationRule($Ve289cc97)
    {
        return $Ve289cc97 & $this->_validationMask;
    }
    public function describeValidationRule($Ve289cc97)
    {
    ...
    public function getValueList($Vd33e904c = null)
    {
