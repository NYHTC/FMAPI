...
class FileMaker_Record_Implementation
{
    ...
    public $V5e7ec2d5 = array();
    public $_recordId;
    public $_modificationId;
    public $_layout;
    public $_fm;
    ...
    public function getField($V06e3d36f, $V6d786dc7 = 0)
    {
    ...
    public function getFieldUnencoded($V06e3d36f, $V6d786dc7 = 0)
    {
        if (!isset($this->_fields[$V06e3d36f])) {
            $this->_fm->log('Field "' . $V06e3d36f . '" not found.', FILEMAKER_LOG_INFO);
            return "";
    ...
    public function getFieldAsTimestamp($V972bf3f0, $V6d786dc7 = 0)
    {
    ...
    public function setField($V06e3d36f, $V2063c160, $V6d786dc7 = 0)
    {
        $this->_fields[$V06e3d36f][$V6d786dc7] = $V2063c160;
        $this->V5e7ec2d5[$V06e3d36f][$V6d786dc7] = true;
        return $V2063c160;
    }
    public function setFieldFromTimestamp($V972bf3f0, $Vd7e6d55b, $V6d786dc7 = 0)
    {
        $V06e3d36f = $this->_layout->getField($V972bf3f0);
        if (FileMaker::isError($V06e3d36f)) {
            return $V06e3d36f;
    ...
    public function &getRelatedSet($Vaca007a7)
    {
    ...
    public function &newRelatedRecord(&$Vd0e45878, $Vaca007a7)
    {
    ...
    public function _commitAddChild()
    {
        $Vd05b6ed7 = array();
    ...
    public function _commitEditChild()
    {
    ...
    public function _updateFrom(&$Vde17f0f2)
    {
    ...
    public function getRelatedRecordById($V97f7e518, $Va6ec9c02)
    {
