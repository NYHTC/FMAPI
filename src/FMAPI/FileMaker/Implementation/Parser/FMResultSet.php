...
class FileMaker_Parser_FMResultSet
{
    ...
    public $Vf5bf48aa;
    public $V1ea7e575;
    public $V9f81f3c0 = array();
    public $Vaae0d98d;
    public $Vae581270 = array();
    public $V6e52c40b = array();
    public $Ve13f1c92;
    public $V43432a31;
    public $V51bc3e3b;
    public $V26005321;
    ...
    public function parse($V0f635d0e)
    {
        if (empty($V0f635d0e)) {
    ...
    public function setResult(&$Vb4a88417, $V561b2299 = 'FileMaker_Record')
    {
        if (!$this->V6de51026) {
    ...
    public function setLayout(&$Vc6140495)
    {
        if (!$this->V6de51026) {
    ...
    public function _start($V3643b863, $Vb068931c, $V5d06e8a3)
    {
    ...
    public function _end($V3643b863, $Vb068931c)
    {
        switch ($Vb068931c) {
            case 'relatedset-definition':
                $this->Ve13f1c92 = null;
    ...
    public function _cdata($V3643b863, $V8d777f38)
    {
