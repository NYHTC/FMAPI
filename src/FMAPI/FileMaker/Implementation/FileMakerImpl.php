...
{
    public $V73ee434e = array('charset' => 'utf-8');
    ...
    public function setProperty($V23a5b8ab, $V2063c160)
    {
        $this->V73ee434e[$V23a5b8ab] = $V2063c160;
    }
    public function getProperty($V23a5b8ab)
    {
    ...
    public function setLogger(&$V6db435f3)
    {
    ...
    public function log($V78e73102, $Vc9e9a848)
    {
    ...
    public function toOutputCharset($V1d770934)
    {
    ...
    public function &newCompoundFindCommand($Vc6140495)
    {
    ...
    public function &newFindRequest($Vc6140495)
    {
    ...
    public function &newFindAllCommand($Vc6140495)
    {
        require_once dirname(__FILE__) . '/../Command/FindAll.php';
        $Vab4d0a65 = new FileMaker_Command_FindAll($this, $Vc6140495);
        return $Vab4d0a65;
    }
    public function &newPerformScriptCommand($Vc6140495, $V2550889a, $V9b479e5e = null)
    {
    ...
    public function &createRecord($Vf43ac2d2, $Vfe0f78a8 = array())
    {
    ...
    public function &getRecordById($Vc6140495, $Va6ec9c02)
    {
    ...
    public function &getLayout($Vf43ac2d2)
    {
    ...
    public function getContainerData($V9305b73d)
    {
    ...
    public function _execute($Vf7cc8e48, $Vb3d1bd6a = 'fmresultset')
    {
        if (!function_exists('curl_init')) {
            return new FileMaker_Error($this, 'cURL is required to use the FileMaker API.');
        }
    ...
    public function getContainerDataURL($V781b3578)
    {
    ...
    public function _setCurlWPCSessionCookie($Vd88fc6ed)
    {
    ...
    public function _setClientWPCSessionCookie($Vd1fc8eaf)
    {
    ...
    public function _getContentLength($Vd1fc8eaf)
    {
    ...
    public function _eliminateXMLHeader($Vd1fc8eaf)
    {
    ...
    public function _eliminateContainerHeader($Vd1fc8eaf)
    {
        $V04d77ddd = strlen("\r\n\r\n");
