...
class FileMaker_Command_Edit_Implementation extends FileMaker_Command_Implementation
{
    ...
    public $_modificationId = null;
    public $V6d6e1fd2;
    public function __construct($V0ab34ca9, $Vc6140495, $Va6ec9c02, $Va0af1e2b = array())
    {
    ...
    public function setFieldFromTimestamp($V06e3d36f, $Vd7e6d55b, $V6d786dc7 = 0)
    {
        $Vc6140495 = &$this->_fm->getLayout($this->_layout);
        if (FileMaker::isError($Vc6140495)) {
            return $Vc6140495;
    ...
    public function setModificationId($Vf048d909)
    {
        $this->_modificationId = $Vf048d909;
    }
    public function _setdeleteRelated($V2063c160)
    {
