...
class FileMaker_Layout_Implementation
{
    ...
    public $_valueLists = array();

    public $Vab234ad8 = array();
    public $_database;
    ...
    public function getValueListTwoFields($V993fcb1e, $Vd33e904c = null)
    {
    ...
    public function getValueList($V993fcb1e, $Vd33e904c = null)
    {
        $Vb4a88417 = $this->loadExtendedInfo($Vd33e904c);
        if (FileMaker::isError($Vb4a88417)) {
            return $Vb4a88417;
    ...
    public function getValueListsTwoFields($Vd33e904c = null)
    {
        $Vb4a88417 = $this->loadExtendedInfo($Vd33e904c);
        if (FileMaker::isError($Vb4a88417)) {
            return $Vb4a88417;
    ...
    public function getValueLists($Vd33e904c = null)
    {
        $Vb4a88417 = $this->loadExtendedInfo($Vd33e904c);
        if (FileMaker::isError($Vb4a88417)) {
            return $Vb4a88417;
    ...
    public function loadExtendedInfo($Vd33e904c = null)
    {
        if (!$this->_extended) {
